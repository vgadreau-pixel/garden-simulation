#!/usr/bin/env python3
"""Captures SAISON COMPLÈTES en vue FPS (printemps + automne), avec
attente généreuse (≥ 4 frames) pour être sûr que le rendu est à jour."""
...
for jour, heure, nom in [(75, 10.0, 'onirique_printemps_fps'), (258, 10.0, 'onirique_automne_fps')]:
    ...
    time.sleep(20)  # large : ≥ 4-5 frames lentes
